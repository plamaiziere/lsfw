...
public class FgTcpUdpSctpService extends FgAddressService {
    ...
    public List<FgPortsSpec> getUdpPortsSpec() {
        return _udpPortsSpecs;
    }

    public List<FgPortsSpec> getTcpPortsSpec() {
        return _tcpPortsSpecs;
    }

    public List<FgPortsSpec> getSctpPortsSpec() {
        return _sctpPortsSpecs;
    }
        ...
        if (all > 0) {
            switch (matchAddress(probe.getDestinationAddress())) {
                case ALL:
                    ...
                    break;
                case MATCH:
                    mres = MatchResult.MATCH;
                    break;
                case NOT:
                    mres = MatchResult.NOT;
                    break;
            }
