...
public class PxOptions {
	...
	public PxRuleAction getPolicyIn() { return _policyIn; }
	public void setPolicyIn(PxRuleAction policyIn) { _policyIn = policyIn; }

	public PxRuleAction getPolicyOut() { return _policyOut; }
	public void setPolicyOut(PxRuleAction policyOut) { _policyOut = policyOut; }
}
